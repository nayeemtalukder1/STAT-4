...
from . models import Student,Gallery,BlogPost,PDFDocument,DataPoint
...
class CustomerProfileForm(forms.ModelForm):
  class Meta:
    model = Student
    fields=['name','university_name','department','batch','roll','address','student_img']
    widgets={
...
class DataPointForm(forms.ModelForm):
    labels = forms.CharField(widget=forms.Textarea, help_text="Enter labels as comma-separated values.")
    values = forms.CharField(widget=forms.Textarea, help_text="Enter values as comma-separated values.")
    ...
    def clean_values(self):
        ...
        try:
            ...
            raise forms.ValidationError("Ensure all values are numbers.")
        return values
